namespace Lyt.Avalonia.TestMvvm;

public partial class App : ApplicationBase
{
    public const string Organization = "Lyt";
    public const string Application = "LytAvaloniaTestMvvm";
    public const string RootNamespace = "Lyt.Avalonia.TestMvvm";
    public const string AssemblyName = "Lyt.Avalonia.TestMvvm";
