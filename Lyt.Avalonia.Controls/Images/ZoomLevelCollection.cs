...
/// <summary> Represents available levels of zoom in an <see cref="ZoomableImage"/> control </summary>
public class ZoomLevelCollection : IList<int>
{
    /// <summary> Initializes a new instance of the <see cref="ZoomLevelCollection"/> class. </summary>
    ...
    public ZoomLevelCollection(IEnumerable<int> collection) : this() => this.AddRange(collection);
    ...
    {
        int index = this.IndexOf(this.FindNearest(zoomLevel));
    ...
    /// <summary> Returns the next decreased zoom level for the given current zoom. </summary>
    /// <param name="zoomLevel">The current zoom level.</param>
    ...
    /// <summary> Gets the number of elements contained in the <see cref="ZoomLevelCollection" />. </summary>
    /// <returns> The number of elements contained in the <see cref="ZoomLevelCollection" />. </returns>
    ...
    /// <summary> Gets or sets the zoom level at the specified index. </summary>
    ...
    /// <summary> Gets or sets the backing list. </summary>
    protected SortedList<int, int> List { get; set; }

    /// <summary> Adds an item to the <see cref="T:System.Collections.Generic.ICollection`1" />. </summary>
    /// <param name="item">The object to add to the <see cref="T:System.Collections.Generic.ICollection`1" />.</param>
    public void Add(int item) => this.List.Add(item, item);

    /// <summary> Adds a range of items to the <see cref="ZoomLevelCollection"/>. </summary>
    ...
    public bool Contains(int item)  => this.List.ContainsKey(item);
    
    /// <summary> Copies a range of elements this collection into a destination <see cref="Array"/>. </summary>
    ...
    /// <summary> Finds the index of a zoom level matching or nearest to the specified value. </summary>
    ...
    public IEnumerator<int> GetEnumerator() => this.List.Values.GetEnumerator();

    /// <summary> Determines the index of a specific item in the <see cref="T:System.Collections.Generic.IList`1" />. </summary>
    /// <param name="item">The object to locate in the <see cref="T:System.Collections.Generic.IList`1" />.</param>
    /// <returns>The index of <paramref name="item" /> if found in the list; otherwise, -1.</returns>
    public int IndexOf(int item) => this.List.IndexOfKey(item);
    ...
    public bool Remove(int item) => this.List.Remove(item);

    /// <summary> Removes the element at the specified index of the <see cref="ZoomLevelCollection"/>. </summary>
    /// <param name="index">The zero-based index of the element to remove.</param>
    public void RemoveAt(int index) => this.List.RemoveAt(index);

    /// <summary> Copies the elements of the <see cref="ZoomLevelCollection"/> to a new array. </summary>
