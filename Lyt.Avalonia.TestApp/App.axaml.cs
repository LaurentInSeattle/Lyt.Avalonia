namespace Lyt.Avalonia.TestApp;

public partial class App : ApplicationBase
{
    public const string Organization = "Lyt";
    public const string Application = "LytAvaloniaTestApp";
    public const string RootNamespace = "Lyt.Avalonia.TestApp";
    public const string AssemblyName = "Lyt.Avalonia.TestApp";
